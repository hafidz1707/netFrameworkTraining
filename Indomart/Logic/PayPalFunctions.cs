...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-9jo7v18067364_api1.business.example.com";
    private string APIPassword = "BEEUSK5EQGND8UVK";
    private string APISignature = "AuaofqQd2e-2NuLkob0HpzqE3dYDA2o5c2ZEni8c.AiuRhRsR2apNQgf";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44333/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44333/Checkout/CheckoutCancel.aspx";
        ...
        using (Indomart.Logic.ShoppingCartActions myCartOrders = new Indomart.Logic.ShoppingCartActions())
        {
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            // Log the exception.
            Indomart.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
        }
